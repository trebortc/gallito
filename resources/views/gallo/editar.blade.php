            ...
            <div class="col">
                ...
                <form action=" {{ url('/gallo/actualizar') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="peso" name="peso" placeholder="Ingrese el peso" step="0.01" value="{{ $gallo->PESO }}" min="{{ $pesoMinimo}}" max="{{ $pesoMaximo}}">
                        </div>
                    </div>
                    <div class="form-group row">
