            ...
            <div class="col">
                ...
                <form action=" {{ url('/inscripcion_torneo/actualizar') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" class="form-control" id="peso_gallo" name="peso_gallo" placeholder="Escriba el peso del gallo" value="{{ $inscripcion->PESO_GALLO }}" step="0.01" min="3.3" max="4.6">
                        </div>
                    </div>
                    <div class="form-group row">
